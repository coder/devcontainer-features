...
# The workbench redirects to the default folder when none is given in the URL.
check "vscode-web default folder flag" grep -e '--default-folder' /usr/local/bin/vscode-web-entrypoint
